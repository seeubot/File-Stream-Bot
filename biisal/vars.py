...
class Var(object):
    ...
    API_HASH = str(getenv('API_HASH', 'd538c2e1a687d414f5c3dce7bf4a743c'))
    BOT_TOKEN = str(getenv('BOT_TOKEN' , '8135238758:AAHtmUvjM43nQOPqPNeQGJqWiufxuRlpIP4'))
    ...
    OWNER_ID = [int(x) for x in os.environ.get("OWNER_ID", "1352497419").split()]
    NO_PORT = bool(getenv('NO_PORT', False))
    APP_NAME = None
    OWNER_USERNAME = str(getenv('OWNER_USERNAME', 'TechLifez'))
    if 'DYNO' in environ:
        ON_HEROKU = True
    ...
    DATABASE_URL = str(getenv('DATABASE_URL', 'mongodb+srv://movie:movie@movie.tylkv.mongodb.net/?retryWrites=true&w=majority&appName=movie'))
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', 'terao2')) 
